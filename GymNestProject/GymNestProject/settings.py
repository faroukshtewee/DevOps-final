"""
Django settings for GymNestProject project.
...
SECRET_KEY = 'django-insecure-v2p2=be__p$6e2p37m_=zv2ksn0@e*uli=(i#6rn&l_)5m_m(7'
...
ROOT_URLCONF = 'GymNestProject.urls'
...
WSGI_APPLICATION = 'GymNestProject.wsgi.application'
